...
type ChargeDetail struct {
	...
	Account           AccountList  `json:"account,omitempty"`
	...
	RepayAccount      AccountList  `json:"repay_account,omitempty"`
	Transfer          bool         `json:"transfer"`
	TransferAccountId uint         `json:"transfer_account_id"`
	TransferAccount   AccountList  `json:"transfer_account,omitempty"`
